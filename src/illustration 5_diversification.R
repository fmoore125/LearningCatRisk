...
x11()
par(mar=c(5,5,3,2))
plot(x=nmarkets,y=apply(diversification,MARGIN=2,FUN=function(x) var(x)/norm),ylim=c(0,5),type="o",col="#FFE74C",pch=20,xlab="Number of Markets",ylab="Variance Insurer Position\n(Relative to One Market Under Stationarity)",las=1,cex=1.4)
